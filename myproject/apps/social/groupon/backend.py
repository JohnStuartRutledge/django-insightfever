"""
Groupon support for Django-Social-Auth

This will connect to the Groupon API 
"""
...
class GrouponBackend(SocialAuthBackend):
    """Groupon authentication backend
    """
    name       = 'groupon'
    EXTRA_DATA = [('id', 'id'), ]
    
    def get_user_details(self, response):
        """Return user details from Groupon account
        """
...
class GrouponAuth(BaseAuth):
    """Groupon authentication mechanism."""
    AUTH_BACKEND         = GrouponBackend
    SETTINGS_KEY_NAME    = 'GROUPON_API_KEY'
    SETTINGS_SECRET_NAME = 'GROUPON_SECRET'
